...
pref("app.releaseNotesURL", "http://github.com/purism/purebrowser");
pref("app.vendorURL", "https://puri.sm/");
...
pref ("distribution.about", "PureBrowser");
pref ("distribution.id", "purism");
